...
void jetYieldCalPtCut_All(){

    TFile* file = new TFile("~/2014Research/ROOT_file/V0reco_pPb_histo/JetTripPb_histo_inJet_3Ndepend_July10_2014.root");
...
//K0s in jet:
    ...
    c1_0->Print("ksHist_July11_injet0.pdf[");
    ...
    c1_1->Print("ksHist_July11_injet1.pdf[");
...
//K0s underlying:
    ...
    c1_2->Print("ksHist_July11_injet2.pdf[");
    ...
    c1_3->Print("ksHist_July11_injet3.pdf[");
...
//Lambda in jet:
    ...
    c2_0->Print("laHist_July11_injet0.pdf[");
    ...
    c2_1->Print("laHist_July11_injet1.pdf[");
    ...
    c2_2->Print("laHist_July11_injet2.pdf[");
    ...
    c2_3->Print("laHist_July11_injet3.pdf[");
...
//Lambda/K0s ratio
    ...
    w1->AddEntry(h3,"N^{offline}_{trk} > 0");
